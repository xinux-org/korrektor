...
files_with_content_to_rename = [
    ...
    Path("data") / "com.belmoussaoui.GtkRustTemplate.service.in",
...
shutil.move(project_dir / "gtk-rust-template.doap", project_dir / f"{project_name}.doap")
